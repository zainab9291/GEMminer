function [] = AWebsiteFinal( ExcelFileNam,FolderpathNam,ForColor,ColNum)
...
fprintf(fptr,'}');
 fprintf(fptr,' #myheader {');
         fprintf(fptr,' /*  float: right;');
            fprintf(fptr,'list-style-type: none;');
            fprintf(fptr,'display: inline-block;*/');
        fprintf(fptr,'}');

        fprintf(fptr,'.myheader a {');
          fprintf(fptr,'list-style-type: none;');
            fprintf(fptr,'float: right;');
            fprintf(fptr,'display: inline-block;');
            fprintf(fptr,'padding:5px 20px;');
            fprintf(fptr,'text-decoration: none;');
            fprintf(fptr,'font-size: 20px;');
            fprintf(fptr,'color: #000;');
            fprintf(fptr,'display: block;');
            fprintf(fptr,'transition: 0.3s;');
            fprintf(fptr,'border: 1px solid #000');
        fprintf(fptr,'}');
        fprintf(fptr,'.myheader a:hover{');
          fprintf(fptr,'background-color: #000;');
          fprintf(fptr,'color: #fff;');
        fprintf(fptr,'}');
...
fprintf(fptr,'<ul class="myheader">');
            fprintf(fptr,'<li> <a href="#">Contact</a> </li>');
            fprintf(fptr,'<li> <a href="#">About</a> </li>');
            fprintf(fptr,'<li> <a href="AWebsiteFinal.html">Home</a> </li>');


        fprintf(fptr,'</ul>');
  fprintf(fptr,'<span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; </span>');

  fprintf(fptr,'<span style="font-size:30px; color:purple; padding-left: 15em; " > GEMMiner</span>');
